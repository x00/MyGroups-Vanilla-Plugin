...
<div class="Info">
    <?php echo anchor(t('Groups'), '/settings/mygroups', array('class' => 'Button Active')); ?>
    <?php echo anchor(t('Group Requests') . ($this->data('groupRequestCount') ? ' ' . wrap($this->data('groupRequestCount', 0), 'span class="Alert"') : ''), '/settings/mygroups/requests', array('class' => 'Button')); ?>
